    ...
    return (
        <>
            <div className="w-200">
                ...
                <Input name="name" value={reportName} onChange={(e)=>setReportNameChange(e.target.value)} className="m-4 w-1/2" placeholder="Enter memberID"></Input>
                <h1 className="m-4">Report Description</h1>
                <textarea name="description" value={reportDescription} onChange={(e)=> setReportDescriptionChange(e.target.value)} rows={4}
