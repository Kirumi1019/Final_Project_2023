    ...
    return (
        <>
            <div className="w-200">
                ...
                <Input name="name" value={productName} onChange={handleProductNameChange} className="m-4 w-1/2" placeholder="Enter product name"></Input>
                <h1 className="m-4">Product Description</h1>
                <textarea name="description" value={productDescription} onChange={handleProductDescriptionChange} rows={4}
                ...
                <Input name="price"  onChange={handleProductPriceChange} type="number" className="m-4 w-1/2" placeholder="Enter price"></Input>
                <h1 className="m-4">Inventory</h1>
                <Input name="inventory" onChange={handleProductInventoryChange} type="number" className="m-4 w-1/2" placeholder="Enter number in stock"></Input>
                <h1 className="m-4">Category</h1>
                <select onChange={handleProductCategoryChange} className="m-4 w-1/2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
